...
const displayPokemon = (pokemon) => {
  ...
  const cardDom = ["div", { class: "card" }, [["div", {
    class: "image-container",
  }, [["img", { src: pokemon.imgUrl, alt: pokemon.name }, ""]]], ["div", {
    ...
    }, [["p", { id: pokemon.name }, type]]]),
  ]]], ["div", { class: "stats-table-container" }, [["table", {
    class: "stats",
  }, [[
    "tbody",
    { id: "table-body" },
    Object.entries(statsData).map((
      [key, val],
    ) => ["tr", { class: "row" }, [["td", { class: "stat-name" }, key], ["td", {
      class: "stat-entry",
    }, val]]]),
  ]]]]]]]]];
